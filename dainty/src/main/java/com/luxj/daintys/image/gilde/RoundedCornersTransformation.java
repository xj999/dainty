...
public class RoundedCornersTransformation implements Transformation<Bitmap> {
    ...
    public RoundedCornersTransformation(Context context, int radius, int margin,
                                        CornerType cornerType, float width, int color) {
        this(Glide.get(context).getBitmapPool(), radius, margin, cornerType, width, color);
    }
    ...
    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin,
        ...
        borderColor = color;
        borderWidth = width;
        borderWidth = Resources.getSystem().getDisplayMetrics().density * width;
        ...
        if (color != 0) {
            ...
            if (width == 0) {
                borderWidth = Resources.getSystem().getDisplayMetrics().density * 2;
            }
        }
    ...
    private void drawRoundRect(Canvas canvas, Paint paint, float width, float height) {
        ...
        switch (mCornerType) {
            case ALL:
                canvas.drawRoundRect(new RectF(borderWidth, borderWidth, width - borderWidth, height - borderWidth), mRadius, mRadius, paint);
                break;
            case TOP_LEFT:
